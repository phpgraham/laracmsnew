<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/menu*')) }}" href="{{ route('admin.menu', ['parent_id' => '0']) }}"><i class="fa fa-list"></i>Menu Manager</a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/pages*')) }}" href="{{ route('admin.pages.index') }}"><i class="fa fa-file-text"></i>Pages Manager</a>
            </li>
